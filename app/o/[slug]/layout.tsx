    ...
    <div className="min-h-screen">
      <nav className="bg-primary-dark px-4 py-3">
        <div className="mx-auto flex max-w-4xl flex-wrap items-center gap-4">
          ...
          <Link href={`/o/${slug}/live`} className={navLinkClass}>
            Live
          </Link>
          <Link href={`/o/${slug}/members`} className={navLinkClass}>
            Members
          </Link>
          <Link href={`/o/${slug}/shop`} className={navLinkClass}>
            Shop
          </Link>
          {(currentOrg.role === "organizer" || currentOrg.role === "org_owner") && (
            <>
              ...
              <Link href={`/o/${slug}/settings/products`} className={navLinkClass}>
                Products
              </Link>
              ...
              <Link href={`/o/${slug}/settings/live`} className={navLinkClass}>
                Live settings
              </Link>
              <Link href={`/o/${slug}/settings/reports`} className={navLinkClass}>
                Reports
              </Link>
              <Link href={`/o/${slug}/settings/member-reports`} className={navLinkClass}>
                Member reports
              </Link>
            </>
          )}
