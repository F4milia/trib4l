...
export default async function CommerceSettingsPage({
  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-10 space-y-6">
      <PageHeading>Commerce</PageHeading>
      ...
      <Card>
        ...
        {status === "incomplete" && (
          <>
            <p className="mb-2">
              <span className="rounded-full bg-danger/10 px-2 py-0.5 text-xs text-danger">Onboarding incomplete</span>
            </p>
        ...
        {status === "active" && (
          <p>
            <span className="rounded-full bg-primary-soft px-2 py-0.5 text-xs text-primary-dark">Active</span>{" "}
